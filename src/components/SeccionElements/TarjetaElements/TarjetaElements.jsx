...
import '../TarjetaElements/tarjetaElements.css'
import BotonGetCode from '../../TarjetaIframe/BotonGetCode/BotonGetCode';
const TarjetaElements = () => {
    ...
    return (
        <div className='container__tarjetaIframe'>
         ...
         <div className='container__tarjetaIframe__botonGetCode'>
         <BotonGetCode />
         </div>
        </div>
    )
}
export default TarjetaElements